...
export default function Notfound() {
  return (
    <div
      className="relative selection:bg-orange-500 selection:text-white  py-10 font-[Tajawal] min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0d0906] text-white">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center max-w-xl">
        ...
        <div className="relative my-8 h-28 w-28 flex items-center justify-center ">
          ...
          <span className="absolute -top-2 -right-3 h-5 w-5 rounded-lg rotate-12 bg-main-orange animate-bounce" />
